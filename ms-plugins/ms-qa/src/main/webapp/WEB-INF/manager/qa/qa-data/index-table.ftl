	...
	<template   id="custom-model" >
		<div  class="ms-index">
			...
			<el-header class="ms-header" height="50px">
				<el-col :span="12">
					<@shiro.hasPermission name="qa:qaData:save">
						<el-button type="primary" icon="el-icon-plus" size="mini" @click="save()">新增</el-button>
					</@shiro.hasPermission>
					<@shiro.hasPermission name="qa:qaData:del">
			...
			<el-main class="ms-container">
				<el-table v-loading="loading" ref="multipleTable" height="calc(100vh-68px)" class="ms-table-pagination" border :data="dataList" tooltip-effect="dark" @selection-change="handleSelectionChange">
					...
					<div v-if="field.isShow == 'true'" v-for="(field,index) in tableField">
						...
						<el-table-column min-width="120" :label="field.name" :prop="field.key" v-else-if="field.type == 'select' || field.type == 'radio' || field.type == 'checkbox' || field.type == 'time' || field.type == 'date'"  :formatter="fmt">
						</el-table-column>
						...
						<el-table-column    label="IP" prop="qa_ip" >
						</el-table-column>
						<el-table-column    label="设备类型" prop="qa_device_type" >
						</el-table-column>
						<el-table-column   label="地区" prop="qa_address" >
						</el-table-column>

					<#--操作-->
					<el-table-column label="操作" align="center" width="200">
						<template slot-scope="scope">
							<@shiro.hasPermission name="qa:qaData:update">
