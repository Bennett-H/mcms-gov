 ...
 */
@Api(tags = {"前端-文章接口"})
@Controller("WebgovcmsContentAction")
@RequestMapping("/gov/cms/content")
public class ContentAction extends net.mingsoft.cms.action.BaseAction{
	...
	@ApiImplicitParams({
			...
			@ApiImplicitParam(name = "style", value = "发布到", required =false,paramType="query"),
	})
	...
	public ResultData list(HttpServletResponse response, HttpServletRequest request) {
		...
		String net = BasicUtil.getString("style","out");
