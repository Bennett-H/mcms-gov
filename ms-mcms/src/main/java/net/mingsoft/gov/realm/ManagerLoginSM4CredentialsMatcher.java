 ...
 *          创建日期：2015年9月9日<br/>
 * 历史修订：
 * 2021-07-13 增加国密处理 75行开始<br/>
 */
public class ManagerLoginSM4CredentialsMatcher extends SimpleCredentialsMatcher {

    private static final Logger LOGGER = LoggerFactory.getLogger(ManagerLoginSM4CredentialsMatcher.class);
