...
public class ProgressLogBizImpl extends BaseBizImpl<IProgressLogDao, ProgressLogEntity> implements IProgressLogBiz {
    ...
    public boolean insertProgressLog(String schemeName, String dataId,String createBy) {
        ...
        List<ProgressEntity> progressEntityList = progressDao.selectList(new QueryWrapper<>(progressEntity).lambda().orderByAsc(ProgressEntity::getProgressNumber));
        ...
        // 创建一条待初审的日志信息
        progressLog.setPlNumber(progressEntity.getProgressNumber());
    ...
    @Override
    public List<ProgressLogBean> queryDataByCategoryId(List<String> categoryIds, String plStatus) {
        return progressLogDao.queryDataByCategoryId(categoryIds, plStatus);
    }
    ...
    public Integer getMaxProgress(ProgressLogEntity progressLogEntity) {
        ...
        ProgressLogEntity progressLog = this.getOne(wrapper, false);
