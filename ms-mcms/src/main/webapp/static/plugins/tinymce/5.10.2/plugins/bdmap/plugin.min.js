 ...
 * Licensed under MIT
 */
  tinymce.PluginManager.add("bdmap",function(a,g){var b=a.getParam("bdmap_options",{width:560,height:360,outputIframe:"/static/plugins/tinymce/5.10.2/plugins/bdmap/bd.html"}),d=(tinymce.baseURL||".")+"/plugins/bdmap/map.html";window.tinymceLng="";window.tinymceLat="";window.tinymceBDZoom="";window.tinymceBDW="";window.tinymceBDH="";window.tinymceBDBoxW="";window.tinymceBDBoxH="";window.tinymceBDBoxHtml="";window.tinymceBDDH="";window.tinymceBDSF="";window.tinymceBDBgColor="";window.tinymceBDDName="";var c=function(){return a.windowManager.openUrl({title:"\u63d2\u5165\u767e\u5ea6\u5730\u56fe",
