...
* github: https://github.com/duheng/assist
**/
  ...
  */
    ...
    _createClass(Base, [{
      ...
      value: function registeOpen() {
        ...
        addEvent(document, 'click', function (event) {
          ...
          var tagId = _this.config.domId || 'assist-open';
          if (target.getAttribute('id') == tagId) {
            if (!_this.existIgnore()) {
              ...
              ms.util.store.set('show', true);

              var __href = document.getElementById(tagId).getAttribute('assist-href');
      ...
      value: function isShow() {
        ...
        addEvent(window, 'DOMContentLoaded', function () {
          if (ms.util.store.get('show')=='true' && !_this2.existIgnore()) {
      ...
      value: function existIgnore() {
        ...
        return  null;//ms.util.store.getTag(namespace).includes(__key);
      }
    }, {
      key: "show",
      value: function show() {
      ...
      value: function showTag() {
        var namespace = this.config.namespace;
        //ms.util.store.setTag(namespace); // 设置忽略
  ...
  var TopBar = {
    ...
    mouseOver: function mouseOver(event) {
      ...
      if (__name == 'audio') {
        if (ms.util.store.get('audio')=='true') {
          target.src = __hover;
        } else {
          target.src = target.getAttribute('selected-hover-src');
        }
      } else if (__name == 'speed') {
        if (ms.util.store.get('speed') == 'fast') {
          target.src = target.getAttribute('selected-hover-src');
        } else {
          target.src = __hover;
        }
  ...
  var Audio = {
    init: function init(core) {
      var _core$config = core.config,
          ...
          au_token = _core$config.au_token;
      this.body = document.body;
      this.namespace = namespace; // 暂时写死

      this.AudioApi = '//tsn.baidu.com/text2audio';
      core.creatStyle('audio-style', styles$3);
      core.creatHtml('audio-html', BigTextHtml$1);
      this.isAudio = ms.util.store.get('audio')=='true'; // 获取语音接口token

      this.au_token = au_token;

      if(!this.au_token) {
        alert("检测到当前站点使用了无障碍功能\n需要先配置好百度语音API接口，才能正常使用无障碍功能\n具体请点击后台系统设置->无障碍配置，配置了如果还提示此信息，需要检查百度API参数是否正确");
      }

      if (localStorage.getItem('_$uid')) {
        this.uid = localStorage.getItem('_$uid');
      } else {
        localStorage.setItem('_$uid', new Date().getTime());
        this.uid = localStorage.getItem('_$uid');
      }
    },
    setEvents: function setEvents(core) {
    ...
    registeDom: function registeDom(namespace) {
      ...
      this.speed = ms.util.store.get('speed');
    ...
    toggleAudio: function toggleAudio() {
      ...
      this.audioTab.onclick = function () {
        ...
        ms.util.store.set('audio', _this.isAudio);
      };
      ...
      this.speedTab.onclick = function () {
        ...
        ms.util.store.set('speed', _this.speed);
      };
    ...
    playAudio: function playAudio(text) {
      ...
      var AudioParam = "lan=zh&ctp=1&tok=".concat(au_token, "&spd=").concat(__speed, "&tex=").concat(encodeURI(text), "&cuid=").concat(uid);
    ...
    reset: function reset() {
      ...
      this.speedTabImg.src = this.speedTabImg.getAttribute('source-src');
      this.speed = 'middle';
      ms.util.store.set('speed', 'middle');
    }
  };
  ...
  var ZoomPage = {
    init: function init(core) {
      var namespace = core.config.namespace;
      this.size = ms.util.store.get('zomm') || 1.0;
    ...
    zoomOut: function zoomOut(core) {
      ...
      this.size = parseFloat((_size + 0.1).toFixed(10));
      this.updateZoomState(core);
      this.set();
    ...
    set: function set() {
      ...
      ms.util.store.set('zomm', this.size);
    },
    reset: function reset() {
      this.size = 1.0;
      this.set();
  ...
  var PointerFllow = {
    ...
    setEvents: function setEvents(core) {
      ...
      if (ms.util.store.get('pointer')=='true') {
        this.show(core);
      }
    ...
    show: function show(core) {
      ...
      activeBtn.style.display = 'block';
      this.addEventMove();
      ms.util.store.set('pointer', true);
    },
    reset: function reset(core) {
      ...
      activeBtn.style.display = 'none';
      this.removeEventMove();
      ms.util.store.set('pointer', false);
    }
  };

  var styles$1 = "* {\n  cursor: url(\"/static/plugins/accessibility/1.0.0/allaw.cur\"), auto !important;\n}\n\na {\n  cursor: url(\"./linkaw.cur\"), auto !important;\n}";
  ...
  var CursorAuto = {
    ...
    setEvents: function setEvents(core) {
      ...
      if (ms.util.store.get('cursor')=='true') {
      ...
      tabBarBtn.onclick = function () {
        ...
        if (activeBtn) {
          ...
          ms.util.store.set('cursor', false);
          Audio.playAudio(audioTabText.cursorAutoClose);
        } else {
          ms.util.store.set('cursor', true);
          core.creatStyle('cursor-auto-style', styles$1, true);
  ...
  var BigText = {
    ...
    setEvents: function setEvents(core) {
      ...
      var namespace = core.config.namespace;
      addEvent(window, 'DOMContentLoaded', function () {
        if (ms.util.store.get('bigtext')=='true') {
          _this.show(core);
        }
      });
    ...
    show: function show(core) {
      ...
      this.addEventMove();
      ms.util.store.set('bigtext', true);
    ...
    reset: function reset(core) {
      ...
      this.removeEventMove();
      ms.util.store.set('bigtext', false);
