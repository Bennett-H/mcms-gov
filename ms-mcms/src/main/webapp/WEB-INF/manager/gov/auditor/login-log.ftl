...
<div id="index" class="ms-index" v-cloak>
    ...
    <el-main class="ms-container">
        <el-table height="calc(100vh - 68px)" v-loading="loading" ref="multipleTable" border :data="dataList" tooltip-effect="dark" @selection-change="handleSelectionChange">
            ...
            <el-table-column label="最后登录时间"  width="200" align="center" prop="createDate">
                <template slot-scope="scope">
                    <el-tag size="medium" v-if="scope.row.createDate=='' || scope.row.createDate==null" type="warning">管理员未登录过系统</el-tag>
    ...
    var indexVue = new Vue({
        ...
        methods:{
            ...
            list: function(isSearch) {
                ...
                ms.http.post(ms.manager+"/gov/auditor/unLoginManager.do",data).then(
                    function(res) {
