...
<div id="index" class="ms-index" v-cloak>
            ...
            <el-form :model="form" ref="searchForm" label-width="120px" size="mini">
                <el-row>
                    <el-col :span="8">
                        ...
                        <el-form-item label="文章id" prop="businessId">
                            <el-input
                                    v-model="form.businessId"
                                    :disabled="false"
                                    :style="{width:  '100%'}"
                                    :clearable="true"
                                    placeholder="请输入完整文章id">
                            </el-input>
                        </el-form-item>
                    </el-col>
                    <el-col :span="8">
    ...
    <el-main class="ms-container">
        <el-table height="calc(100vh - 68px)" v-loading="loading" ref="multipleTable" border :data="dataList"
            ...
            <el-table-column label="文章id" width="200" align="left" prop="businessId">
                <template #default="scope">
                    <el-tooltip
                        ...
                        <span v-if="scope.row.businessId && scope.row.businessId.length <= 15">
                            {{scope.row.businessId}}
                        </span>
                        <span v-if="scope.row.businessId&& scope.row.businessId.length > 15">
                            {{scope.row.businessId.substr(0, 15) + "..."}}
                        </span>
                    </el-tooltip>
                    <span v-else-if="scope.row.businessId== null"> NA </span>
                </template>
            </el-table-column>
...
<script>
    var indexVue = new Vue({
        ...
        data: {
            ...
            logBusinessTypeOptions: [{"value": "content_update", "label": "修改文章"}, {
                "value": "content_insert",
                "label": "新增文章"
            }, {"value": "content_delete", "label": "删除文章"}],
        ...
        methods: {
            ...
            list: function () {
                ...
                ms.http.post(ms.manager + "/co/log/content/list.do", form.sqlWhere ? Object.assign({}, {sqlWhere: form.sqlWhere}, page)
